...
namespace EventHorizon.Game.Server.Zone
{
    ...
    {
        public static IServiceCollection AddSystemClientAssets(this IServiceCollection services)
        {
            return services
                .AddSingleton<ClientAssetRepository, ClientAssetInMemoryRepository>();
        }
        public static void UseSystemClientAssets(this IApplicationBuilder app)
        {
            using (var serviceScope = app.ApplicationServices.GetService<IServiceScopeFactory>().CreateScope())
            {
                serviceScope.ServiceProvider
                    .GetService<IMediator>()
                    .Send(new LoadSystemClientAssetsCommand())
                    .GetAwaiter()
                    .GetResult();
            }
        }
