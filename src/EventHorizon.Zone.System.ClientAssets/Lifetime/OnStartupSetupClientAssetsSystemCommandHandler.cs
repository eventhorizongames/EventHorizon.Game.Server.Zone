...
public class OnStartupSetupClientAssetsSystemCommandHandler
    : IRequestHandler<
          OnStartupSetupClientAssetsSystemCommand,
          OnServerStartupResult
      >
{
    ...
    )
    {
        ...
        return new OnServerStartupResult(true);
    }
    ...
    )
    {
        ...
        if (
            !await _mediator.Send(
                new DoesDirectoryExist(particlePath),
                cancellationToken
            )
        )
        {
            ...
            await _mediator.Send(
                new CreateDirectory(particlePath),
                cancellationToken
            );
        }
    }
