    ...
    public static class PluginExtensions
    {
        public static IServiceCollection AddPlugins(this IServiceCollection services, IHostingEnvironment hostingEnvironment)
        {
            return services
                ...
                .AddSingleton<PluginState>(new ServerPluginState(hostingEnvironment, services, new ServerPluginLoader())); 
        }
        public static IApplicationBuilder UsePlugins(this IApplicationBuilder app)
        {
            using (var serviceScope = app.ApplicationServices.GetService<IServiceScopeFactory>().CreateScope())
            {
                ...
                mediator.Publish(new StartupPluginsEvent()).GetAwaiter().GetResult();
            }
