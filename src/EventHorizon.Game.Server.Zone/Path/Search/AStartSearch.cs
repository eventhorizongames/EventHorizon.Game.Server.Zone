...
namespace EventHorizon.Game.Server.Zone.Path.Search
{
    public static class AStarSearch
    {
        ...
        )
        {
            ...
            g_score[_source] = 0;
            f_score[_source] = HeuristicEuclidCalculate(mapGraph, _source, _target);
        ...
        // HeuristicEuclid
        private static float HeuristicEuclidCalculate(MapGraph mapGraph, int node1Index, int node2Index)
        {
