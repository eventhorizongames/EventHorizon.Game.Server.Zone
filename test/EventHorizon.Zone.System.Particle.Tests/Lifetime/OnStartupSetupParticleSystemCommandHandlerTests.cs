...
public class OnStartupSetupParticleSystemCommandHandlerTests
{
    ...
    {
        // Given
        var expectedResourceRoot =
            "EventHorizon.Zone.System.Particle";
        var clientPath = "client-path";

        var loggerMock = new Mock<
            ILogger<OnStartupSetupParticleSystemCommandHandler>
        >();
        var mediatorMock = new Mock<IMediator>();
        var serverInfoMock = new Mock<ServerInfo>();

        serverInfoMock
            .Setup(mock => mock.ClientPath)
            .Returns(clientPath);
        ...
        mediatorMock
            ...
            .ReturnsAsync(new StandardCommandResult());

        // When
        var handler =
            new OnStartupSetupParticleSystemCommandHandler(
                loggerMock.Object,
                mediatorMock.Object,
        ...
        actual
            .Should()
            .Be(new OnServerStartupResult(true));
                ...
                mock.Send(
                    It.Is<WriteResourceToFile>(
                        a =>
                            ...
                            && a.ResourcePath
                                == testData.ExpectedResourcePath
                            && a.ResourceFile
                                == testData.ExpectedResourceFile
                            && a.SaveFileFullName
                                == testData.ExpectedFileFullName
                    ),
                    CancellationToken.None
                )
        );
    ...
    )
    {
        ...
        mediatorMock
            ...
            .ReturnsAsync(
                new StandardCommandResult(errorCode)
            );
