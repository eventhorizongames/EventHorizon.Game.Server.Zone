...
namespace EventHorizon.Game.Server.Zone.Tests.Entity.Search.Handler
{
    public class SearchInAreaWithAllTagsHandlerTests
    {
        ...
        public async Task TestHandle_ShouldCallIntoEntitySearchTreeWithEventParameters()
        {
            ...
            var expectedEntityList = await SearchInAreaHandler.Handle(new SearchInAreaWithAllTagsEvent
            {
            ...
            // Then
            entitySearchTreeMock.Verify(a => a.SearchInAreaWithAllTags(expectedSearchPositionCenter, expectedSearchRadius, expectedTagList));
        }
        [Fact]
        public async Task TestHandle_ShouldReturnEntityIdListFromEntitySearchTree()
        {
            ...
            var entitySearchTreeMock = new Mock<IEntitySearchTree>();
            entitySearchTreeMock.Setup(a => a.SearchInAreaWithAllTags(expectedSearchPositionCenter, expectedSearchRadius, expectedTagList)).ReturnsAsync(expectedSearchEntityList);
