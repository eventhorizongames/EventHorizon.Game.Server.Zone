namespace EventHorizon.Zone.System.Gui.Tests.Command;

using EventHorizon.Zone.System.Admin.Plugin.Command.Events;
using EventHorizon.Zone.System.Admin.Plugin.Command.Model.Standard;
using EventHorizon.Zone.System.Gui.Command;
...
public class ReloadGuiSystemAdminCommandEventHandlerTests
{
    [Fact]
    public async Task ShouldNotRunReloadWhenCommandIsNotReloadSystem()
    {
        ...
        var expected = new ReloadGuiSystemCommand();

        var loggerMock = new Mock<ILogger<ReloadGuiSystemAdminCommandEventHandler>>();
        var mediatorMock = new Mock<IMediator>();

        // When
        var handler = new ReloadGuiSystemAdminCommandEventHandler(
            loggerMock.Object,
            mediatorMock.Object
        );
    ...
    public async Task ShouldSendResponseCommandWhenCommandIsReloadSystem()
    {
        ...
        var commandParts = new List<string>();
        var data = new { };
        var responseMessage = "gui_system_reloaded";
