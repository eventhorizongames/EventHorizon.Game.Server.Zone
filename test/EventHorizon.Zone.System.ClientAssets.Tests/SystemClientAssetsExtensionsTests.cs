...
public class SystemClientAssetsExtensionsTests
{
    ...
    {
        // Given
        var serviceCollectionMock =
            new ServiceCollectionMock();
        ...
        Assert.Collection(
            ...
            service =>
            {
                service.ServiceType
                    .Should()
                    .Be(typeof(ClientAssetRepository));
                service.ImplementationType
                    .Should()
                    .Be(
                        typeof(ClientAssetInMemoryRepository)
                    );
            }
        );
    }
    ...
    {
        var applicationBuilderMocks =
            ApplicationBuilderFactory.CreateApplicationBuilder();
        var expected = new LoadSystemClientAssetsCommand();

        applicationBuilderMocks.ServiceProviderMock
            .Setup(
        ...
        // When
        var actual =
            SystemClientAssetsExtensions.UseSystemClientAssets(
        ...
        mediatorMock.Verify(
            mock =>
                mock.Send(expected, CancellationToken.None)
        );
    }
}
