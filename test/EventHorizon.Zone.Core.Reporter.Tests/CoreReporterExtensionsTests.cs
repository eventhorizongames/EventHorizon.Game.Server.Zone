namespace EventHorizon.Zone.Core.Reporter.Tests
{
    ...
    public class CoreReporterExtensionsTests
    {
        ...
        public void ShouldConfigureServiceCollectionWhenAddCoreReporterIsCalled()
        {
            ...
            var reportTrackingRepositoryBySettingsMock =
                new Mock<ReportTrackingRepositoryBySettings>(
                    reportTrackingRepositoryMock.Object,
                    reporterSettingsMock.Object
                );
            var elasticsearchReporterClientBasedOnElasticClientMock =
                new Mock<ElasticsearchReporterClientBasedOnElasticClient>(
                    It.IsAny<ILogger<ElasticsearchReporterClientBasedOnElasticClient>>(),
                    reporterSettingsMock.Object
                );

            serviceProviderMock
                .Setup(mock => mock.GetService(typeof(ReportTrackingRepository)))
                .Returns(reportTrackingRepositoryMock.Object);
            serviceProviderMock
                .Setup(mock => mock.GetService(typeof(ReportTrackingRepositoryBySettings)))
                .Returns(reportTrackingRepositoryBySettingsMock.Object);

            serviceProviderMock
                .Setup(
                    mock => mock.GetService(typeof(ElasticsearchReporterClientBasedOnElasticClient))
                )
                .Returns(elasticsearchReporterClientBasedOnElasticClientMock.Object);

            // When
            CoreReporterExtensions.AddCoreReporter(serviceCollectionMock);
            ...
            Assert.Contains(
                ...
                service =>
                    ...
                    && service.ImplementationType
                        == typeof(CheckElasticsearchReporterClientConnectionTimerTask)
            );
            Assert.Contains(
                serviceCollectionMock,
                service =>
                    service.ServiceType == typeof(ElasticsearchReporterClientBasedOnElasticClient)
                    && service.ImplementationType
            ...
            Assert.Contains(
                ...
                service =>
                    ...
                    && service.ImplementationFactory(serviceProviderMock.Object)
                        is ElasticsearchReporterClientBasedOnElasticClient
            );
            Assert.Contains(
                serviceCollectionMock,
                service =>
            ...
            Assert.Contains(
                serviceCollectionMock,
                service =>
                    service.ServiceType == typeof(ReportTrackingRepository)
                    && service.ImplementationType == typeof(ReportTrackingRepository)
            );
            Assert.Contains(
                serviceCollectionMock,
                service =>
                    service.ServiceType == typeof(ReportTrackingRepositoryBySettings)
                    && service.ImplementationType == typeof(ReportTrackingRepositoryBySettings)
            );
            Assert.Contains(
                serviceCollectionMock,
                service =>
                    service.ServiceType == typeof(ReporterSettings)
            ...
            Assert.Contains(
                ...
                service =>
                    ...
                    && service.ImplementationFactory(serviceProviderMock.Object)
                        is ReportTrackingRepositoryBySettings
            );
            Assert.Contains(
                serviceCollectionMock,
                service =>
            ...
            Assert.Contains(
                serviceCollectionMock,
                service =>
                    typeof(ITimerTask) == service.ServiceType
